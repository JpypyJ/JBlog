module.exports = {
  ...
  title: "JBlog",
  base: '/JBlog/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/architecture/',
        items: [
          { text: '软件架构与需求分析', link: '/architecture/softwareArch/'}
        ],
      },
      // {
      //   text: '索引',
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/favicon2.ico' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'author',
